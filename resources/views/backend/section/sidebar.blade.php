                ...
                <div>
                    <div class="logo-wrapper logo-wrapper-center">
                        <a href="index.html" data-bs-original-title="" title="">
                            <img class="img-fluid for-white" src="{{asset('backend/assets/images/logo/full-white.svg')}}" alt="logo">
                        </a>
                        <div class="back-btn">
                    ...
                    <div class="logo-icon-wrapper">
                        <a href="index.html">
                            <img class="img-fluid main-logo" src="{{asset('backend/assets/images/logo/logo.png')}}" alt="logo">
                        </a>
                    </div>
