...
<head>
    ...
    <meta name="description" content="Zomo admin is super flexible, powerful, clean &amp; modern responsive bootstrap 5 admin template with unlimited possibilities.">
    <meta name="keywords" content="admin template,Zomo admin template, dashboard template, flat admin template, responsive admin template, web app">
                ...
                <div>
                    <div class="logo-wrapper logo-wrapper-center">
                        <a href="index.html" data-bs-original-title="" title="">
                            <img class="img-fluid for-white" src="assets/images/logo/full-white.svg" alt="logo">
                        </a>
                        <div class="back-btn">
                            ...
                            <ul class="sidebar-links" id="simple-bar">
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        ...
                                        <li>
                                            <a href="add-new-categorys.html">Create Category</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        ...
                                        <li>
                                            <a href="add-new-attribute.html">Add Attributes</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        <li>
                                            <a href="foods.html">Food List</a>
                                        </li>

                                        <li>
                                            <a href="add-new-food.html">Create Food</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="sidebar-list">
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        ...
                                        <li>
                                            <a href="create-roles.html">Create Role</a>
                                        </li>
                                    </ul>
                                </li>
                                                ...
                                                <div class="theme-arrow">
                                                    <div class="swiper categories-slider categories-style">
                                                        <div class="swiper-wrapper">
                                                            ...
                                                            <div class="swiper-slide">
                                                                <a href="category.html" class="food-categories">
                                                                    <img class="img-fluid categories-img" src="assets/images/product/5.png" alt="p-6">
                                                                    <h4 class="dark-text">Boritto</h4>
                                                                </a>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <a href="category.html" class="food-categories">
                                                                    <img class="img-fluid categories-img" src="assets/images/product/6.png" alt="p-7">
                                                                    <h4 class="dark-text">Taco</h4>
                                                                </a>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <a href="category.html" class="food-categories">
                                                                    <img class="img-fluid categories-img" src="assets/images/product/7.png" alt="p-8">
                                                                    <h4 class="dark-text">Muffin</h4>
                                                                </a>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <a href="category.html" class="food-categories">
                                                                    <img class="img-fluid categories-img" src="assets/images/product/8.png" alt="p-9">
                                                                    <h4 class="dark-text">Meat</h4>
                                                                </a>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <a href="category.html" class="food-categories">
                                                                    <img class="img-fluid categories-img" src="assets/images/product/9.png" alt="p-5">
                                                                    <h4 class="dark-text">Panner</h4>
                                                                </a>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <a href="category.html" class="food-categories">
                                                                    <img class="img-fluid categories-img" src="assets/images/product/10.png" alt="p-11">
                                                                    <h4 class="dark-text">Hotdog</h4>
                                                                </a>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <a href="category.html" class="food-categories">
                                                                    <img class="img-fluid categories-img" src="assets/images/product/11.png" alt="p-12">
                                                                    <h4 class="dark-text">Donuts</h4>
                                                                </a>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <a href="category.html" class="food-categories">
                                                                    <img class="img-fluid categories-img" src="assets/images/product/12.png" alt="p-13">
                                                                    <h4 class="dark-text">Coffee</h4>
                                                                </a>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <a href="category.html" class="food-categories">
                                                                    <img class="img-fluid categories-img" src="assets/images/product/13.png" alt="p-14">
                                                                    <h4 class="dark-text">Sandwich</h4>
                                                                </a>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <a href="category.html" class="food-categories">
                                                                    <img class="img-fluid categories-img" src="assets/images/product/14.png" alt="p-15">
                                                                    <h4 class="dark-text">Noddle</h4>
                                                                </a>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <a href="category.html" class="food-categories">
                                                                    <img class="img-fluid categories-img" src="assets/images/product/15.png" alt="p-16">
                                                                    <h4 class="dark-text">Pasta</h4>
                                                                </a>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <a href="category.html" class="food-categories">
                                                                    <img class="img-fluid categories-img" src="assets/images/product/16.png" alt="p-17">
                                                                    <h4 class="dark-text">Meggi</h4>
                                                                </a>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <a href="category.html" class="food-categories">
                                                                    <img class="img-fluid categories-img" src="assets/images/product/17.png" alt="p-18">
                                                                    <h4 class="dark-text">Momos</h4>
                                                                </a>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <a href="category.html" class="food-categories">
                                                                    <img class="img-fluid categories-img" src="assets/images/product/18.png" alt="p-19">
                                                                    <h4 class="dark-text">Salad</h4>
                                                                </a>
                                                            </div>
                                                            <div class="swiper-slide">
                                                                <a href="category.html" class="food-categories">
                                                                    <img class="img-fluid categories-img" src="assets/images/product/19.png" alt="p-20">
                                            ...
                                            <table class="table user-table" id="table_id">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="table-image">
                                                                <img src="assets/images/dashboard/product-2/1.jpg" class="img-fluid" alt="">
                                                                <h5>Fish Burger</h5>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="table-image">
                                                                <img src="assets/images/dashboard/product-2/2.jpg" class="img-fluid" alt="">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="table-image">
                                                                <img src="assets/images/dashboard/product-2/3.jpg" class="img-fluid" alt="">
                                                                <h5>Hot Dog</h5>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="table-image">
                                                                <img src="assets/images/dashboard/product-2/4.jpg" class="img-fluid" alt="">
                                                                <h5>Nachos</h5>
                                                            </div>
                                                        </td>
                                                        <td>Sophia Garcia</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="table-image">
                                                                <img src="assets/images/dashboard/product-2/5.jpg" class="img-fluid" alt="">
                                                                <h5>Beef Burger</h5>
                                                            </div>
                                                        </td>
                                                        <td>Michael Smith</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="table-image">
                                                                <img src="assets/images/dashboard/product-2/6.jpg" class="img-fluid" alt="">
